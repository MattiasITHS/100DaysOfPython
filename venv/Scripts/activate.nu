...
def-env activate-virtualenv [] {
    ...
    let virtual_env = 'C:\Users\mathov\PycharmProjects\coffeeMachine\venv'
    let bin = 'Scripts'
    let path_sep = ';'
...
alias deactivate = source 'C:\Users\mathov\PycharmProjects\coffeeMachine\venv\Scripts\deactivate.nu'
