...
game_over_hole = "You fell into a hole. Game over."
...
if left_right.lower() == "left":
    ...
    if swim_wait == "wait":
        ...
        door_red = "red"
        door_yellow = "yellow"
        if island_doors == "blue":
            print("You found the treasure! You win!")
        elif island_doors == "yellow":
            print("A room full of monsters! Game over")
        else:
            print("An empty room! Game over")
    else:
        print("You tried to swim acrossed but drowned!")
